...
<head>
    ...
    <title>{{ __('Confirmación de pago') }} - {{ config('app.name', 'Membresia') }}</title>
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="bg-white rounded-lg shadow-xl p-4 sm:p-6 mt-4">
                <div v-if="paymentIntent.status === 'succeeded'">
                    ...
                    <p class="mb-6">
                        Este pago fue confirmado exitosamente.
                    </p>
                </div>
                ...
                <div v-else-if="paymentIntent.status === 'processing'">
                    ...
                    <p class="mb-6">
                        Este pago está siendo procesado. Refresca esta página de vez en cuando para ver su estado.
                    </p>
                </div>
                ...
                <div v-else>
                    ...
                    <div v-if="paymentIntent.status === 'requires_payment_method'" class="mb-3">
                        ...
                        <p class="mb-6">
                            Se necesita un método de pago válido para procesar tu pago. Por favor confirma tu pago llenando los detalles a continuación.
                        </p>
                        ...
                        <div v-if="paymentMethods.length > 1">
                            <p class="text-sm mb-3">
                                Por favor selecciona el método de pago que deseas usar.
                            </p>
                        ...
                        <div v-else>
                            <p class="text-sm mb-3">
                                Tu pago será procesado por @{{ paymentMethodTitle }}.
                            </p>
                        </div>
                        ...
                        <div v-if="(paymentMethod || {}).remember">
                            ...
                            <label for="remember" class="inline-block text-sm text-gray-700 mb-2">
                                ...
                                Recoder metodo de pago para uso futuro
                            </label>
                    ...
                    >
                        ...
                        <span v-else>
                            Confirma tu pago de {{ $amount }} Con @{{ paymentMethodTitle }}
                        </span>
                    </button>
                </div>
